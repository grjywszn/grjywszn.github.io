...
function createBDGroup( portion ) {
  var clazz = portion.docker === 0 && portion.isEnd
    ? 'biaodian cjk'
  ...
  jinzify: function( selector ) {
    ...
    .replace(
      ...
      function( portion, match ) {
        ...
        return (( portion.docker === 0 && portion.isEnd ) || portion.docker === 1 ) ? elem : ''
      }
    )
    .replace(
      TYPESET.jinze.wei,
    ...
    .replace(
      ...
      function( portion, match ) {
        ...
        elem.innerHTML = match[0]
        return (( portion.docker === 0 && portion.isEnd ) || portion.docker === 1 )
          ? elem : ''
      }
    )
    .replace(
...
function firstStepLabel( portion, mat ) {
  return portion.isEnd && portion.docker === 0
    ? mat[1] + hws + mat[2]
    : portion.docker === 0
...
function apostrophe( portion ) {
  ...
  if (
    ...
    portion.docker === 1 || portion.indexInMatch === last$hwsIdx
  )) {
